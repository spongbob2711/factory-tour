...
$email->addContent(
    "text/html",
    "Hallo,<br><br>Terima kasih atas pemesanannya Bapak/Ibu $name. Anda telah melakukan pemesanan acara Marimas Factory Tour pada tanggal $date.<br><br>Terima Kasih atas pemesannanya,<br>Marimas Company"
);
